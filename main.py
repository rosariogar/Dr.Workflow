...
import pandas as pd
def main():
    print("Bienvenido!, soy Dr. Workflow. Te ayudaré a realizar un análisis de los datos de tus pacientes")
    nombreUsuario = input("Por favor, ingrese su nombre para poder dirigierme a usted: ")
    ...
    while True:
        ...
        if choice == "1":
            file_path = input("Ingrese la ruta completa donde se encuentran los datos que desea analizar: ")
